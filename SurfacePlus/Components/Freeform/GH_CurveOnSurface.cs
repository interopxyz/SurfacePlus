...
{
    public class GH_CurveOnSurface : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the CurveOnSurface class.
        /// </summary>
        public GH_CurveOnSurface()
          : base("Curve On Surface 2", "Crv Srf 2",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddPointParameter("Points", "P", "3d Points", GH_ParamAccess.list);
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.Sp_Crv_Crv_Srf_Fit;
            }
        }
