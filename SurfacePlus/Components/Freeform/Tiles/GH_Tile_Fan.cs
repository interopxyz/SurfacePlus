...
{
    public class GH_Curve_Triangulate : GH_Tile__Base
    {
        /// <summary>
        /// Initializes a new instance of the GH_Curve_Triangulate class.
        /// </summary>
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            List<Surface> surfaces = curve.Fan(shift, out bool status);
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.Sp_Tile_Fan;
            }
        }
        ...
        {
            get { return new Guid("12135ecd-10c0-46a8-b72d-a6f718ada06f"); }
        }
    }
}